        ...
        <div class="gf-product-slider__tabs">
            <ul>
                <?php if (isset($instance['tab_1']) and !empty($instance['tab_1'])): ?>
                    <li><a href="#tab_1"><?= get_term_by('slug', $instance['tab_1'], 'product_cat')->name ?></a></li>
                <?php endif; ?>
                <?php if (isset($instance['tab_2']) and !empty($instance['tab_2'])): ?>
                    <li><a href="#tab_2"><?= get_term_by('slug', $instance['tab_2'], 'product_cat')->name ?></a></li>
                <?php endif; ?>
                <?php if (isset($instance['tab_3']) and !empty($instance['tab_3'])): ?>
                    <li><a href="#tab_3"><?= get_term_by('slug', $instance['tab_3'], 'product_cat')->name ?></a></li>
                <?php endif; ?>
                <?php if (isset($instance['tab_4']) and !empty($instance['tab_4'])): ?>
                    <li><a href="#tab_4"><?= get_term_by('slug', $instance['tab_4'], 'product_cat')->name ?></a></li>
                <?php endif; ?>
                <?php if (isset($instance['tab_5']) and !empty($instance['tab_5'])): ?>
                    <li><a href="#tab_5"><?= get_term_by('slug', $instance['tab_5'], 'product_cat')->name ?></a></li>
                <?php endif; ?>
